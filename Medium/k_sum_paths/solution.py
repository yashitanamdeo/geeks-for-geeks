# Problem Statement: https://www.geeksforgeeks.org/problems/k-sum-paths/1
...
class Solution:
    def find_subtree_sum_paths(self, node, target_sum, current_sum, sum_frequency):
        ...
        self.find_subtree_sum_paths(
            node.left, target_sum, current_sum, sum_frequency)
        self.find_subtree_sum_paths(
            node.right, target_sum, current_sum, sum_frequency)
    ...
    def sumK(self, root, target_sum):
        ...
        sum_frequency = {0: 1}
        self.find_subtree_sum_paths(
            root, target_sum, current_sum, sum_frequency)
