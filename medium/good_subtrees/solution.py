# Problem Statement: https://practice.geeksforgeeks.org/problems/df12afc57250e7f6fc101aa9c272343184fe9859/1
...
class Solution:
    ...
    def returnTotalGoodSubtrees(self, root, k):
        ...
        myset.add(root.data)
        goodSubtrees = leftPart[0]+rightPart[0] + \
            1 if len(myset) <= k else leftPart[0]+rightPart[0]
